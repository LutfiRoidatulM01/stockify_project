    ...
    <div class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5">
        <div class="w-full mb-1">
            <div class="mb-4">
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl">Laporan Barang Masuk dan Keluar</h1>
            ...
            <div class="block md:flex md:items-center md:justify-between space-y-4 md:space-y-0 md:space-x-4">
                ...
                <div class="w-full md:w-auto flex justify-center">
                    <a href="{{ route('manajer.laporan.laporan.export', request()->all()) }}"
                ...
                <div class="overflow-hidden shadow">
                    <table class="min-w-full divide-y divide-gray-200 table-fixed">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($laporan_barang as $laporan)
