...
@section('content')
    ...
    <div
        ...
        <div class="w-full mb-1">
            <div class="mb-4">
                    ...
                    <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                        ...
                        <li>
                            <div class="flex items-center">
                                <svg class="w-6 h-6 text-gray-400 dark:text-gray-600" fill="currentColor"
                ...
                <h1 class="text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">Produk</h1>
            </div>
                ...
                <div class="overflow-hidden shadow dark:shadow-gray-700">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 table-fixed">
                        ...
                        <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
                            @foreach ($products_manajer as $product)
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-800">
                                    ...
                                    <td class="p-4 space-x-2 whitespace-nowrap">
                                        <!-- Button Detail -->
                                        <button type="button"
                                            data-modal-target="detail-product-modal-{{ $product->id }}"
                                            data-modal-toggle="detail-product-modal-{{ $product->id }}"
                                            class="text-yellow-400 hover:text-white border border-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 dark:border-yellow-300 dark:text-yellow-300 dark:hover:text-white dark:hover:bg-yellow-400 dark:focus:ring-yellow-900">
                                            <svg class="w-4 h-4 mr-2 inline-block" fill="currentColor"
                                                viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd"
                                                    d="M18 10A8 8 0 11 10 2a8 8 0 0116 0zM9 9a1 1 0 112 0v4a1 1 0 11-2 0V9zM9 6a1 1 0 112 0 1 1 0 11-2 0z"
                                                    clip-rule="evenodd"></path>
                                            </svg>
                                            Detail
                                        </button>
    ...
    {{-- <div
        ...
        <div class="flex items-center mb-4 sm:mb-0">
            <a href="{{ $products_manajer->previousPageUrl() }}"
            ...
            <a href="{{ $products_manajer->nextPageUrl() }}"
            ...
            <span class="text-sm font-normal text-gray-500">Showing <span
                    class="font-semibold text-gray-900">{{ $products_manajer->firstItem() }}</span> to
                <span class="font-semibold text-gray-900">{{ $products_manajer->lastItem() }}</span>
                of <span class="font-semibold text-gray-900">{{ $products_manajer->total() }}</span></span>
        </div>
    ...
    @foreach ($products_manajer as $product)
            ...
            <div class="relative w-full h-full max-w-md px-4 md:h-auto">
                ...
                <div class="relative bg-white rounded-lg shadow">
                    ...
                    <div class="p-6 pt-0 text-center">
                        ...
                        <form id="delete-form-{{ $product->id }}" action="" method="POST">
                            @csrf
                            @method('DELETE')
        ...
        <div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full"
            id="detail-product-modal-{{ $product->id }}">
            <div class="relative w-full h-full max-w-2xl px-4 md:h-auto">
                <!-- Modal Content -->
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="flex justify-between items-center p-5 border-b rounded-t dark:border-gray-600">
                        ...
                        <button type="button"
                            ...
                            data-modal-hide="detail-product-modal-{{ $product->id }}">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                                    d="M10 18a8 8 0 100-16 8 8 0 000 16zm1.707-10.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 001.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293z"
                                    clip-rule="evenodd"></path>
                            </svg>
                        </button>
                    </div>
                    ...
                    <div class="p-6 space-y-6">
                        <img src="{{ asset('storage/' . $product->image) }}" alt="Gambar Produk"
                            class="w-full h-64 object-cover rounded dark:border-gray-600">
                        ...
                        <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                            ...
                            <li><strong>Stok:</strong> {{ $product->totalStock() }}</li>
                            <li><strong>Harga Jual:</strong> Rp{{ number_format($product->selling_price, 2, ',', '.') }}
                            </li>
                            <li><strong>Harga Beli:</strong> Rp{{ number_format($product->purchase_price, 2, ',', '.') }}
                            </li>
                    ...
                    <div
                        ...
                        <button data-modal-hide="detail-product-modal-{{ $product->id }}" type="button"
