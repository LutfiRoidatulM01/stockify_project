        ...
        <div class="w-full mb-1">
                    ...
                    <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="#"
                                    class="ml-1 text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">Supplier</a>
                            </div>
                        </li>
                        <li>
                            <div class="flex items-center">
            ...
            <div class="sm:flex">
                ...
                <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                    <button type="button" data-modal-target="add-suppliers-modal" data-modal-toggle="add-suppliers-modal"
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($suppliers as $supplier)
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap">{{ $supplier->id }}
                                    </td>
            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <div class="flex items-start justify-between p-5 border-b rounded-t">
                    ...
                    <button type="button"
                        ...
                        data-modal-toggle="add-suppliers-modal">
            ...
            <div class="relative w-full h-full max-w-md px-4 md:h-auto">
                ...
                <div class="relative bg-white rounded-lg shadow">
                    ...
                    <div class="p-6 pt-0 text-center">
                        ...
                        <h3 class="mt-5 mb-6 text-lg text-gray-500">Apakah kamu yakin ingin menghapus supplier?</h3>
