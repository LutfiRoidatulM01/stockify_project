                ...
                <table class="min-w-full divide-y divide-gray-200 table-fixed">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-100">
                            <td class="w-4 p-4">
                                <div class="flex items-center">
                                    <input id="checkbox-{{ $category->id }}" aria-describedby="checkbox-{{ $category->id }}" type="checkbox" class="w-4 h-4 border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-primary-300">
                                    <label for="checkbox-{{ $category->id }}" class="sr-only">checkbox</label>
                                </div>
                            </td>
                            <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap">{{ $category->id }}</td>
                            <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap">{{ $category->name }}</td>
                            <td class="max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs">{{ $category->description }}</td>
                            {{-- <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap">{{ $category->products_count }}</td>
                            <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap">{{ $category->created_at }}</td>
                            <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap">{{ $category->updated_at }}</td> --}}
                            <td class="p-4 space-x-2 whitespace-nowrap">
                                ...
                                <button type="button" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-red-700 rounded-lg hover:bg-red-800 focus:ring-4 focus:ring-red-300">
                                    Delete item
                                </button>
                            </td>
                        </tr>
