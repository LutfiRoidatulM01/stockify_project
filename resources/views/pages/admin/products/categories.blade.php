        ...
        <div class="w-full mb-1">
            ...
            <div class="items-center justify-between block sm:flex md:divide-x md:divide-gray-100">
                ...
                <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                    <button type="button" data-modal-target="add-categories-modal" data-modal-toggle="add-categories-modal"
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($categories as $category)
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap">{{ $category->id }}
                                    </td>
                                    ...
                                    <td class="p-4 space-x-2 whitespace-nowrap">
                                        <button type="button" data-modal-target="edit-categories-modal-{{ $category->id }}"
                                            data-modal-toggle="edit-categories-modal-{{ $category->id }}"
                                        ...
                                        <button type="button" data-modal-target="delete-categories-modal-{{ $category->id }}"
                                            data-modal-toggle="delete-categories-modal-{{ $category->id }}"
    ...
    <div
        ...
        <div class="flex items-center mb-4 sm:mb-0">
            ...
            <span class="text-sm font-normal text-gray-500">Showing <span
                    class="font-semibold text-gray-900">{{ $categories->firstItem() }}</span> to
            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <div class="flex items-start justify-between p-5 border-b rounded-t">
                    ...
                    <button type="button"
                        ...
                        data-modal-toggle="add-categories-modal">
...
@endif
    ...
    @foreach ($categories as $category)
        <div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full"
            id="edit-categories-modal-{{ $category->id }}">
            <div class="relative w-full h-full max-w-2xl px-4 md:h-auto">
                <!-- Modal content -->
                <div class="relative bg-white rounded-lg shadow">
                    <!-- Modal header -->
        ...
        <div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full"
            id="delete-categories-modal-{{ $category->id }}">
            <div class="relative w-full h-full max-w-md px-4 md:h-auto">
                ...
                <div class="relative bg-white rounded-lg shadow">
                    ...
                    <div class="flex justify-end p-2">
                        <button type="button"
                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center"
                            data-modal-hide="delete-categories-modal-{{ $category->id }}">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                                    d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                    ...
                    <div class="p-6 pt-0 text-center">
                        ...
                        <h3 class="mt-5 mb-6 text-lg text-gray-500">Apakah kamu yakin ingin menghapus kategori</h3>
