                ...
                <div>
                    ...
                    <div class="relative mt-1">
                        <input type="text" id="search" name="search"
                            placeholder="Cari berdasarkan produk atau supplier..."
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach ($stock_opname as $stok)
                            <tr>
                                <td class="px-6 py-3 text-sm text-gray-900">{{ $stok->id }}</td>
                                <td class="px-6 py-3 text-sm text-gray-900">{{ $stok->product->name }}</td>
                                <td class="px-6 py-3 text-sm text-gray-900">{{ $stok->product->sku }}</td>
                                <td class="px-6 py-3 text-sm text-gray-900">{{ $stok->stok_sistem }}</td>
                                <td class="px-6 py-3 text-sm text-gray-900">{{ $stok->stok_fisik }}</td>
                                <td class="px-6 py-3 text-sm text-gray-900">{{ $stok->selisih }}</td>
                                <td class="px-6 py-3 text-sm text-gray-900">{{ $stok->keterangan }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
