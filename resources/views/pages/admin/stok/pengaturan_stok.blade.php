    ...
    <div class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5">
        <div class="w-full mb-1">
            <div class="mb-4">
                    ...
                    <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="#"
                                    class="ml-1 text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">Pengaturan Stok</a>
                            </div>
                        </li>
                        <li>
                            <div class="flex items-center">
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl">Pengaturan Stok Minimun</h1>
            </div>
            <div class="sm:flex">
            ...
            <div class="relative w-full h-full max-w-2xl px-4 md:h-auto">
                ...
                <div class="relative bg-white rounded-lg shadow">
                    ...
                    <div class="p-6 space-y-6">
                        <form action="{{ route('products.updateMinimumStock', $product->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    <label for="minimum_stock"
                                        class="block mb-2 text-sm font-medium text-gray-900">Stok Minimum</label>
                                    <input type="number" name="minimum_stock" value="{{ $product->minimum_stock }}" id="minimum_stock"
