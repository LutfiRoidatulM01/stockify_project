            ...
            <div class="flex items-center justify-start">
                ...
                <a href="{{ url('/') }}" class="flex ml-2 md:mr-24">
                    @if($settings && $settings->app_logo)
                        <img src="{{ asset('storage/' . $settings->app_logo) }}" alt="Logo" class="h-12 w-12 mr-2">
                    @endif
                    <span class="self-center text-xl font-bold sm:text-2xl whitespace-nowrap" style="color:#3B82F6;">{{ $settings->app_name ?? 'Nama Aplikasi' }}</span>
                </a>
                ...
                <div class="z-50 hidden max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:divide-gray-600 dark:bg-gray-700"
                    ...
                    <div>
                        <a href="#"
                            ...
                            <div class="flex-shrink-0">
                                <img class="rounded-full w-11 h-11"
                                    src="{{ asset('static/images/users/bonnie-green.png') }}" alt="Jese image">
                                <div
                        ...
                        <a href="#"
                            ...
                            <div class="flex-shrink-0">
                                <img class="rounded-full w-11 h-11"
                                    src="{{ asset('static/images/users/joseph-mcfall.png') }}" alt="Joseph image">
                                <div
                        ...
                        <a href="#"
                            ...
                            <div class="flex-shrink-0">
                                <img class="rounded-full w-11 h-11"
                                    src="{{ asset('static/images/users/leslie-livingston.png') }}" alt="Leslie image">
                                <div
                        ...
                        <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-600">
                            <div class="flex-shrink-0">
                                <img class="rounded-full w-11 h-11"
                                    src="{{ asset('static/images/users/robert-brown.png') }}" alt="Robert image">
                                <div
